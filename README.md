...
LaunchLens answers those questions in one reproducible workflow. The included scenario simulates an AI discovery assistant tested across 12,000 users, with realistic novelty effects, user segments, pre-period behavior, latency, quality scores, safety flags, and inference cost.
